...
export default function Header({
  ...
  const statusBadge = () => {
    if (tournamentStatus === "pre")
      return (
        <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold bg-masters-gold/20 text-masters-gold border border-masters-gold/40">
    ...
    if (tournamentStatus === "active")
      return (
        <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold bg-green-400/20 text-green-300 border border-green-400/40">
  ...
  return (
    <header className="bg-masters-gradient shadow-2xl">
      {/* Top bar */}
